...
<div class="card card-primary">
    <!-- /.card-header -->
    <!-- form start -->
    <form action="{{route('penjualankavling.update', $penjualankavling->id)}}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
            ...
            <div class="form-group ">
              ...
              <select name="kategori_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan1->id}}" {{$penjualan1->id ? 'selected' : null}}>{{$penjualan1->nama}}</option>
                  @endforeach
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="subkategori_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan2->id}}" {{$penjualan2->id ? 'selected' : null}}>{{$penjualan2->namasub}}</option>
                  @endforeach
              </select>
            </div>
            <div class="form-group">
              ...
              <select name="datakavling_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan3->id}}" {{$penjualan3->id ? 'selected' : null}}>{{$penjualan3->cluster}}</option>
                  @endforeach
              </select>
            </div>
             <div class="form-group">
              ...
              <select name="datapembeli_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan4->id}}" {{$penjualan4->id ? 'selected' : null}}>{{$penjualan4->nopembeli}}-{{$penjualan4->namapembeli}}</option>
                  @endforeach
              </select>
            </div>
            <div class="form-group">
              ...
              <select name="metodepembayaran_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan5->id}}" {{$penjualan5->id ? 'selected' : null}}>{{$penjualan5->pembayaran}}</option>
                  @endforeach
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="lamaangsurantambah_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option value="{{$penjualan6->id}}" {{$penjualan6->id ? 'selected' : null}}>{{$penjualan6->lamapembayaran}} Bulan - {{$penjualan6->subkategori->namasub}}</option>
                  @endforeach
              </select>
            </div>
              ...
              <div class="form-group">
                ...
                <select name="datamarketing_id" class="form-control cb" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">                  
                  <option disabled selected>-- Pilih Data --</option>
                    ...
                    <option value="{{$penjualan7->id}}" {{$penjualan7->id ? 'selected' : null}}>{{$penjualan7->nomarketing}}-{{$penjualan7->nama}}</option>
                    @endforeach
                </select>
              </div>
            <div class="form-group">
              <label for="promo">Promo</label>
              <input type="text" value="{{$penjualankavling->promo}}" class="form-control" id="promo" name="promo" placeholder="Masukkan nama subkategori">
            </div>
            <div class="form-group">
              <label for="dp">Jumlah DP</label>
              <input type="text" value="{{$penjualankavling->dp}}" class="form-control" id="dp" name="dp" placeholder="Masukkan nama subkategori">
            </div>
            <div class="form-group">
              <label for="tertanggal">Tertanggal</label>
              <br>
              <input type="date" value="{{$penjualankavling->tertanggal}}" name="tertanggal" id="tertanggal" placeholder="Tanggal Lahir" class="form-control">
            </div>
