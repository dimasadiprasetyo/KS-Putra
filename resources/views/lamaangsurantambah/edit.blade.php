        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <select name="subkategori_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                    ...
                    <option value="{{$subkategorine->id}}" {{$subkategorine->id ? 'selected' : null}}>{{$subkategorine->namasub}}</option>
                    @endforeach
                </select>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" {{$lamaangsurantambah->lamapembayaran}} id="lamapembayaran" name="lamapembayaran" placeholder="Masukkan nama kategori">
                  </div>
                    </div>
