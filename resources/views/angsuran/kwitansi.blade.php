...
<body>
    ...
    <table border="0" width=”250″ height=”300″ style="font-size: 14px">
        <thead>
            <tr>
              <td colspan="23" style="font-size: 17px" style="font-style: italic"><strong>Telah Diterima</strong> </td>
              <td colspan="0"></td>
            </tr>
            <!--1-->
            <tr style="font-style: italic" >
                <td colspan="17"></td>
                <td  style="font-size: 15px">Dari</td>
                <td >:</td>
                <td >Sdr/i {{$infopembeli->datapembeli->namapembeli}}</td>
                <td colspan="10"  style="text-indent: 500px"></td>
            </tr>
            
            <tr style="font-style: italic">
                <td colspan="17"></td>
                <td  style="font-size: 15px">Nomor Kavling</td>
                <td>:</td>
            ...
            <tr style="font-style: italic">
                <td colspan="17"></td>
                <td  style="font-size: 15px">Sebesar</td>
                <td>:</td>
                <td >Rp. {{number_format($angsurans->bayarangsuran, 0, ',','.')}},-</td>
                <td colspan="10"  style="text-indent: 500px"></td>
            </tr>
            <tr style="font-style: italic">
                <td colspan="17"></td>
            ...
            <tr style="font-style: italic">
                ...
                <td >Untuk</td>
                <td>:</td>
                <td >Pembayaran Angsuran Ke- {{$angsurans->angsuran}}</td>
                <td colspan="10"  style="text-indent: 500px"></td>
            </tr>
            <br>
            <br>
            ...
            <tr style="font-style: italic">
                ...
                <td >Periode</td>
                <td>:</td>
                <td colspan="25" style="text-indent: 500px">{{$infopembeli->lamaangsurantambah->lamapembayaran}} Bulan</td>
                <td colspan="10"  style="text-indent: 500px"></td>
            </tr>
            <tr>
                <td colspan="98">
            ...
            <tr>
                ...
                <td ></td>
                <td colspan="50"></td>
                <td colspan="30" style="text-indent: 800px">Pekalongan, {{\Carbon\Carbon::parse($angsurans->tanggal)->isoFormat('D MMMM Y')}}</td>
